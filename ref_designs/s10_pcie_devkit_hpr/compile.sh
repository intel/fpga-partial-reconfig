...
quartus_cdb -r s10_pcie_devkit_hpr -c s10_pcie_devkit_hpr --export_block root_partition --snapshot final --file s10_pcie_devkit_hpr_static.qdb --preserve_sdc
quartus_sh --flow compile s10_pcie_devkit_hpr -c s10_pcie_devkit_hpr_ddr4_access
quartus_cdb -r s10_pcie_devkit_hpr -c s10_pcie_devkit_hpr_ddr4_access --export_block pr_partition --snapshot final --file s10_pcie_devkit_hpr_ddr4_access_pr_partition_final.qdb --preserve_sdc
