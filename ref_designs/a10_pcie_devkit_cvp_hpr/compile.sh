...
quartus_cdb -r a10_pcie_devkit_cvp -c a10_pcie_devkit_cvp_ddr4_access --export_block pr_partition --snapshot final --file a10_pcie_devkit_cvp_ddr4_access_pr_partition_final.qdb
